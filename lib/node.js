...
class Node extends kadence.KademliaNode {
  ...
  static get DEFAULTS() {
    return {
      ...
      flags: [],
      trustPolicies: [{ identity: '*', methods: ['*'] }]
    };
  }
   ...
   * @param {object[]} [options.trustPolicies] - Kadence trust policies
   */
  constructor(options) {
    ...
    this.trust = this.plugin(kadence.trust(opts.trustPolicies,
      kadence.trust.MODE_WHITELIST));
