...
class Node extends KademliaNode {
  ...
  constructor(options) {
    ...
    super(opts); // TODO Replace with KadAdapter around database adapter
    ...
    this.offers = new Map(); // TODO: Remove
    this.contracts = opts.contracts; // TODO Replace with database adapter
    ...
    this.claims = opts.claims; // TODO: Remove
  ...
  listen() {
    ...
    this.use('OFFER', handlers.offer.bind(handlers)); // TODO: Remove
    ...
    this.use('PROBE', handlers.probe.bind(handlers)); // TODO: Remove
  ...
  publishShardDescriptor(contract, options, callback) {
    // TODO: Consider removing in favor of CLAIMs
  ...
  resolveContractOffer(hash, offer, error, contract, callback) {
    // TODO: Consider removal in favor of CLAIMs
  ...
  subscribeShardDescriptor(descriptorCodes, callback) {
    // TODO: Consider removing contract publications altogether
    // TODO: We should favor direct CLAIMs
  ...
  offerShardAllocation(peer, descriptor, callback) {
    // TODO: Consider remove OFFER altogether
  ...
  subscribeCapacityAnnouncement(descriptorCodes, callback) {
    // TODO: Remove codes in favor of keyword
  ...
  publishCapacityAnnouncement(descriptorCode, data, callback) {
    // TODO: Remove topic codes in favor of keyword
    // TODO: Include additional profile data in announcement if needed
